	...
	for (int step =1; step<=2; step++)
	{
		...
		for (int i=regions.size()-1; i>=0; i--)
		{
			...
			/*
				 ...
				 (regions.at(i).num_holes_>2) || (regions.at(i).bbox_.width <=3) || 
		...
		}
		{
			...
			char str[100];sprintf(str,"%s.%d.meaningfulcluster.jpg",argv[1],step);
		...
		*/
		...
		//@去重
		{
			...
			// cout<<"coutClusters:"<<final_clusters.size()<<endl;
